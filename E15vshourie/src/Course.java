...
public class Course {
	...
	public Student add() {
		// Declares and instantiates a Student object.
		Student tmpStudent = new Student();
		
		// Adds the student to the student roster for the course object. 
		studentRoster.add(tmpStudent);
		studentCount++;
		
		// Returns the student to another part of the program. 
		return tmpStudent;
	}
